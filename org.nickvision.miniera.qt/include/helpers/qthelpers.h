...
#define QLEMENTINE_ICON(NAME) ::Nickvision::Miniera::Qt::Helpers::QtHelpers::getIcon(oclero::qlementine::icons::Icons16::NAME)

namespace Nickvision::Miniera::Qt::Helpers::QtHelpers
{
    /**
