# Contributing to Nickvision Miniera
...
Before you ask a question, it is best to search for existing [Discussions](https://github.com/NickvisionApps/Miniera/discussions) and [Issues](https://github.com/NickvisionApps/Miniera/issues) that might help you. 
...
- Open a [Discussion](https://github.com/NickvisionApps/Miniera/discussions).
...
- See if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in both the [Discussions](https://github.com/NickvisionApps/Miniera/discussions) and [Issues](https://github.com/NickvisionApps/Miniera/issues) sections.
- Collect information about the bug:
  - Debug information provided by the application
    - GNOME: From the main hamburger menu, open About Miniera → Troubleshooting → Debugging Information and copy the information to the clipboard to paste in your issue.
...
- Open a [new Issue](https://github.com/NickvisionApps/Miniera/issues/new) and explain the behavior you are experiencing and what you expect to happen.
...
This section guides you through submitting an enhancement suggestion for Nickvision Miniera, **including completely new features and minor improvements to existing functionality**. Following these guidelines will help maintainers and the community in understanding your suggestion and finding related suggestions.

#### Before Submitting an Enhancement

- Make sure that you are using the latest released version.
- Perform a search through [Discussions](https://github.com/NickvisionApps/Miniera/discussions) and [Issues](https://github.com/NickvisionApps/Miniera/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
- Find out whether your idea fits with the scope and aims of the project. It's up to you to make a strong case to convince the project's developers of the merits of this feature. Keep in mind that we want features that will be useful to the majority of our users and not just a small subset.

#### How Do I Submit a Good Enhancement Suggestion?

Enhancement suggestions are tracked as [GitHub issues](https://github.com/NickvisionApps/Miniera/issues).
...
- **Explain why this enhancement would be useful** to most Miniera users. You may also want to point out similar projects of other platforms and their solutions to serve as inspiration.
...
Miniera is available to translate on [Weblate](https://hosted.weblate.org/engage/nickvision-miniera/)!

##### Manually

To start translating the app, fork the repository and clone it locally.

Miniera uses [gettext](https://www.gnu.org/software/gettext/manual/gettext.html#PO-Files) for translations. In the `resources/po` folder you will find files that can be edited in your favourite `*.po` files editor (or with any plain text editor). 

If you want to create a new translation, copy the `miniera.pot` file and rename said copy as `<lang_code>.po`, where `<lang_code>` is the language code for your translation. Usually the code is two letters, but it can also be a specific locale code to differentiate between versions of the same language (for example, `pt` and `pt_BR`). **Also, add the language code to `LINGUAS` file** (keeping this file in alphabetical order).
...
Miniera is built using C++20 and platform-native user interface libraries. With these technologies, Miniera is built for all desktop platforms.

The project is split up into the following sub-projects:
 - [libminiera](#libminiera)
 - [org.nickvision.miniera.gnome](#org.nickvision.miniera.gnome)
 - [org.nickvision.miniera.qt](org.nickvision.miniera.qt)
...
Miniera simply relies on `cmake` to configure and manage the correct projects for the running platform. Meaning, on Linux the `.gnome` variant of the app will be built by default and on Windows the `.qt` variant.
...
Miniera uses the following naming conventions:
...
Miniera uses the following coding styles:
- ```cpp
    #ifndef FILENAME_H
    #define FILENAME_H
    ...
